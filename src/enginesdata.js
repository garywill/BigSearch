...
function init_data() {
    ...
    sEngines = {
        ...
        "greasy_fork": {
            dname: "Greasy Fork",
            full_url: "https://greasyfork.org/zh-CN/scripts?q={0}"
        },
        "slz": {
            dname: "Sleazy Fork",
        ...
        "css_wd": {
            ...
            full_url: "https://userstyles.org/styles/browse?search_terms={0}&type=false"
        },
        "css_org": {
        ...
        "css_org_achv": {
            dname: "UserStyles.org Archive",
            full_url: "https://uso.kkx.one/browse/styles?search={0}"
        },
        "css_sch": {
            dname: "Search Together",
            use_other_engine: [
                "css_wd",
                "css_org",
                "css_org_achv"
